...
class DraggableTable extends PureComponent {
    ...
    render() {
        ...
        const columns = [
            {
                title: getString('draggableTable.job'),
                dataIndex: 'job',
                render: text => conventEnumValueToString(jobType, text, this.props.language),
                sorter: (a, b) => compare(a, b, 'job', 0)
            },
            {
                title: getString('draggableTable.username'),
                dataIndex: 'username',
                sorter: (a, b) => compare(a, b, 'username', '')
            },
            {
                title: getString('draggableTable.name'),
                dataIndex: 'name',
                sorter: (a, b) => compare(a, b, 'name', '')
            },
            {
                title: getString('draggableTable.dealerName'),
