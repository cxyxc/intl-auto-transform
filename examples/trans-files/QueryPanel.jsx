                ...
                <Row>
                    ...
                    <Col {...FORM_OPTIONS.col}>
                        <FormItem label={getString('STATUS')} {...FORM_OPTIONS.item}>
                            <WrappedSelect name="status" value={status} allowClear onChange={this.onChange} options={employeeStatus.toList()} />
                        </FormItem>
                    </Col>
                </Row>
                <Row>
                    <FormItem label={getString('JOB')} {...FORM_ROW_OPTIONS.item}>
                        <TagSelect name="job" value={job} options={jobType.toList()} onChange={this.onChange} />
                    </FormItem>
                </Row>
                <Row>
                    ...
                    {this.props.canUpdateRelation && (
                        <Link className={styles.right} to={routes.updateRelation.url()}>
                            {getString('EDIT_PERSONNEL_RELATIONSHIP')}
                        </Link>
                    )}
                </Row>
            </Card>
