...
export const updateEmployee = id => (dispatch, getState) => {
    ...
    const requiredField = [];
    if(isNullOrUndefined(tmpEmployeeInfo.sex)) requiredField.push(getString('SEX'));
    if(isNullOrUndefined(tmpEmployeeInfo.job)) requiredField.push(getString('BUSINESS_POST'));
    if(isNullOrUndefined(tmpEmployeeInfo.dealerId)) requiredField.push(getString('BRANCH'));
